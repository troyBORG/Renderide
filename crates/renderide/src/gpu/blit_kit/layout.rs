...
//!
//! The base layouts use filterable color textures and filtering samplers. The UV variant adds a
...
/// `(0)` filterable D2Array, `(1)` filtering sampler. Used by stereo multiview blit passes.
